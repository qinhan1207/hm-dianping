...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    ...
    private void isBlogLiked(Blog blog) {
        ...
        Double scoer = stringRedisTemplate.opsForZSet().score(key, userId.toString());
        blog.setIsLike(scoer != null);
    }
    ...
    public Result likeBlog(Long id) {
        ...
        if (score == null) {
            ...
            if (isSuccess) {
                // 3.2.保存用户到redis有序集合 ZADD key value score
    ...
    public Result queryBlogLikes(Long id) {
        ...
        // 2.解析出其中的用户id
        List<Long> ids = top5.stream().map((value) -> Long.valueOf(value)).collect(Collectors.toList());
